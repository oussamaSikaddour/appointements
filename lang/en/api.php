...
"medical_file" => [
    "responses" => [
        'unauthorized_delete' => "Only the owner of the medical file can delete it",
        "destroy" => "The medical file has been deleted successfully"
    ],
    "errors" => [
        "not-found" => "The medical file owner could not be found"
    ]
],
"appointment" => [
    "responses" => [
