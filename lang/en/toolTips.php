...
'appointment' => [
    ...
    "location_map" => "Appointment Location Map",
    'referral_letter' => "View Referral Letter",
    "excel" => [
        "download" => "Download Appointments List"
    ]
],
'medical_file' => [
    "delete" => "Delete medical file",
    "update" => "Update medical file ",
    "manage" => [
        "view" => "View medical file details"
    ],
],
'patient_visit' => [
    "delete" => "Delete patient visit Report",
    "update" => "Update patient visit Report",
    "manage" => [
        "images" => "Manage Patient visit documents (Image Format)",
        "files" => "Manage Patient visit documents (PDF Format)",
    ],
],
