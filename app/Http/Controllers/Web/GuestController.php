...
class GuestController extends Controller
{
    ...
    public function showIndexPage(): View
    {
        ...
        return view('pages.index', compact('title')); // Load the index view
    }
    ...
    public function showLoginPage(): View
    {
        ...
        return view('pages.guest.login', compact('title')); // Load guest login view
    }
    ...
    public function showRegisterPage()
    {
        ...
        return view('pages.guest.register', compact('title')); // Load guest register view
    }
    ...
    public function showForgetPasswordPage()
    {
        ...
        return view('pages.guest.forgetPassword', compact('title')); // Load forget password view
    }
}
