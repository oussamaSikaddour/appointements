...
class AuthController extends Controller
{
    ...
    public function login(LoginRequest $request): JsonResponse
    {
        ...
        try {
            $user = User::with(['roles', 'occupations', 'personnelInfo', 'bankingInformation', 'images'])
    ...
    public function changePassword(ChangePasswordRequest $request): JsonResponse
    {
        try {
            ...
            if (!$isSuperAdmin && !Hash::check($data['password'], $user->password)) {
    ...
    private function buildAuthSuccessResponse(User $user, string $type): JsonResponse
    {
        ...
        $plainTextToken = $this->createUserToken($user);
        $user->loadMissing(['occupations', 'personnelInfo', 'bankingInformation', 'images']);
