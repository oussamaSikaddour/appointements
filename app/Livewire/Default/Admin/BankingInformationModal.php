...
use App\Livewire\Forms\BankingInformation\AddForm;
use App\Livewire\Forms\BankingInformation\UpdateForm;
use App\Models\Bank;
...
class BankingInformationModal extends Component
{
    ...
    public function mount()
    {
      ...
      $localeName = app()->getLocale()==="en"?"fr":app()->getLocale();
        $this->bankableName = $this->bankable["name_{$localeName}"];
    ...
    public function render()
    {
        ...
        return view('livewire.default.admin.banking-information-modal');
    }
}
