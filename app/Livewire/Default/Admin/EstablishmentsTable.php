...
class EstablishmentsTable extends Component
{
          ...
          use WithPagination, TableTrait, GeneralTrait,WithFileUploads, ResponseTrait, TextAndPdfTrait;
...
public function establishments()
{
    ...
    public function openDeleteDialog($establishment)
    {
        $data = [
            "question" => "dialogs.title.establishment",
            "details" => ["establishment", $establishment['name_' . $this->local]],
            "actionEvent" => [
    ...
    public function updated(string $property): void
    {
         ...
         if($property ==="excelFile"){
            $errorsFileData= $this->whenExcelFileUploaded("EstablishmentsImport",__('tables.establishments.excel.upload.success') );
    ...
    {
        return view('livewire.default.admin.establishments-table');
    }
