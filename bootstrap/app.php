...
use App\Http\Middleware\Api\CheckMaintenanceModeApi;
use App\Http\Middleware\Api\EnsureAccountIsActiveApi;
use App\Http\Middleware\Api\SetLocaleApi;
use App\Http\Middleware\Web\CheckMaintenanceMode;
use App\Http\Middleware\Web\EnsureAccountIsActiveWeb;
        ...
        then: function () {
            ...
            Route::middleware('web')->group(function () {
                foreach ([
                    ...
                    'routes/web/author.php',
                    'routes/web/superAdmin.php',
                    'routes/web/establishmentAdmin.php',
                    'routes/web/appointmentsLocationAdmin.php',
                    'routes/web/serviceAdmin.php',
                    'routes/web/doctor.php',
                ] as $file) {
            ...
            Route::middleware('api')->group(function () {
                foreach ([
                    ...
                    'routes/api/occupations.php',
                    'routes/api/bankingInformation.php',
                    'routes/api/medicalFiles.php',
                    'routes/api/appointments.php',
                ] as $file) {
                    require base_path($file);
                }
            });
