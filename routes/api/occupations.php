...
Route::group([
    ...
    // GET /api/{locale}/occupations/{user}
    Route::get('{user}', [OccupationController::class, 'index']);

    // Store a new occupation for a given user
    // POST /api/{locale}/occupations/{user}
    Route::post('{user}', [OccupationController::class, 'store']);

    // Show a specific occupation for a given user
    // GET /api/{locale}/occupations/{user}/{occupation}
    Route::get('{user}/{occupation}', [OccupationController::class, 'show']);

    // Update a specific occupation for a given user
    // PATCH /api/{locale}/occupations/{user}/{occupation}
    Route::patch('{user}/{occupation}', [OccupationController::class, 'update']);
